...
const cacheName = 'Fixit8Julia_-2020-09-30 16:16:33.143853'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit8Julia_'.length) === 'Fixit8Julia_') {
